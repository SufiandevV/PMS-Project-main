        ...
        <div className="flex flex-col min-h-screen w-screen bg-white overflow-x-hidden">
          <div className="p-6 m-auto w-1/4 bg-white rounded-md shadow-xl ring-inset lg:max-w-xl border border-gray-200">
            ...
            <form className="mt-6">
              ...
              <a
                href="#"
                className="text-sm text-blue-800 flex justify-end hover:underline"
              >
                Forget Password?
              </a>
              <div className="mt-6">
...
<div className="flex items-center pt-4 space-x-1">
		...
		<p className=" text-sm font-light text-center text-blue-950">Login with social accounts</p>
		<div className="flex-1 h-px sm:w-16 bg-blue-700"></div>
	</div>
	<div className="flex justify-center space-x-4">
		<button aria-label="Log in with Google" className="p-3 rounded-sm bg-blue-600 mt-4">
		...
		<button aria-label="Log in with Twitter" className="p-3 rounded-sm bg-blue-600 mt-4">
			<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className="w-5 h-5 fill-current text-white">
		...
		<button aria-label="Log in with GitHub" className="p-3 rounded-sm bg-blue-600 mt-4">
			<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className="w-5 h-5 fill-current text-white">
            ...
            <p className="mt-8 text-sm font-light text-center text-blue-950">
              {" "}
