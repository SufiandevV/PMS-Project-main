function Dashboard() {
  return (
    <div className="bg-white h-screen">
      <div className="p-4 lg:ml-80 lg:mr-8 my-6 bg-opacity-100 sm:mx-4 text-blue-700">
        <h4 className="text-blue-600">Trainee / Home</h4>
        <h1 className="text-4xl font-bold text-left tracking-tight leading-10 mb-4 mt-4">
          Trainee Dashboard
        </h1>
